...
//w2l -c -g -U -F -P -u  /home/fabiolinux/Documentos/GITHUB/PREPARO/cwitsml/api/PARSERS/witsml_v1.4.1.1_data/generated_write_schemas/* -o write1411.h -twrite1411.dat
//scpp -c -S -s -t -2 -pwrite1411 write1411.h
...
#include "write/write1411H.h"

SOAP_FMAC5 int SOAP_FMAC6 wr1411__writeObj1411(struct soap *soap_internal, struct wr1411__writeObj1411_USCOREt *obj, char **result)
{
  *result="Soap internal OK";
  printf("\nSoap internal (WRITE) %p with obj %p and attachments %p\n",soap_internal, obj, obj->attachments);
  return SOAP_OK;
}
